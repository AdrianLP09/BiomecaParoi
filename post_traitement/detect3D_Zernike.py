...
if __name__=='__main__':
    ...
    nZ = 9
    data_folder = f'../2025_04_28/results_calib/nZ_{nZ}/'

    calibration_dict = {
      'cam1_folder' : f'../opti_angle_calib/{date}/40d_cd/left/',
      'cam2_folder' : f'../opti_angle_calib/{date}/40d_cd/right/',
      'name' : 'calibration',
    ...
    saving_folder=f'../2025_05_05/nZ_{nZ}/SC37_40_P1/'
...
#            if abs(Lp[0][0][Lfalse[j][1]][1] - Lfalse[k][0][1]) < 4: #pour 28 degrés et 30 degrés l=20 cm
    ...
    np.savetxt(f'../data/SC37_40_P1/X3d_SC37_40.txt', Lx3d)
    np.savetxt(f'../data/SC37_40_P1/Y3d_SC37_40.txt', Ly3d)
    np.savetxt(f'../data/SC37_40_P1/Z3d_SC37_40.txt', Lz3d)

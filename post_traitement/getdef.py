...
date = "2023_07_06"
X3d = np.loadtxt(fname=f'../opti_angle_calib/{date}/40d_cd/X3d_SC37_40.txt', delimiter=' ')
Y3d = np.loadtxt(fname=f'../opti_angle_calib/{date}/40d_cd/Y3d_SC37_40.txt', delimiter=' ')
Z3d = np.loadtxt(fname=f'../opti_angle_calib/{date}/40d_cd/Z3d_SC37_40.txt', delimiter=' ')
